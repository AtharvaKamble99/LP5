...
public class Token_Mutual {
    private static boolean hasToken;
    private static String nextSiteIP;
    private static int listenPort;
    private static int sendPort;

    public Token_Mutual(boolean hasToken, String nextSiteIP, int listenPort, int sendPort) {
        Token_Mutual.hasToken = hasToken;
        Token_Mutual.nextSiteIP = nextSiteIP;
        Token_Mutual.listenPort = listenPort;
        Token_Mutual.sendPort = sendPort;
    }
    public void start() {
    ...
    public static void main(String[] args) {
        ...
        Token_Mutual toke = new Token_Mutual(hasToken, nextSiteIP, listenPort, sendPort);
        toke.start();
    }
}
